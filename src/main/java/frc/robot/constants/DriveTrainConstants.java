...
/**
 * stores the constants and PID configs for chassis because we want an all-real
 * simulation for the chassis, the numbers
 * are required to be considerably precise
 */
public class DriveTrainConstants {
        /**
         * numbers that needs to be changed to fit each robot TODO: change these numbers
         * to match your robot
         */
        ...
        /**
         * numbers imported from {@link TunerConstants} TODO: for REV chassis, replace
         * them with actual numbers
         */
        ...
        public static final LinearAcceleration MAX_FRICTION_ACCELERATION = MetersPerSecondPerSecond
                        .of(GRAVITY_CONSTANT * WHEEL_COEFFICIENT_OF_FRICTION);
        ...
        public static final LinearVelocity CHASSIS_MAX_VELOCITY = MetersPerSecond
                        .of(DRIVE_MOTOR.freeSpeedRadPerSec / DRIVE_GEAR_RATIO * WHEEL_RADIUS.in(Meters));
        public static final LinearAcceleration CHASSIS_MAX_ACCELERATION = (LinearAcceleration) Measure
                        .min(MAX_FRICTION_ACCELERATION, MAX_PROPELLING_FORCE.divide(ROBOT_MASS));
        public static final AngularVelocity CHASSIS_MAX_ANGULAR_VELOCITY = RadiansPerSecond
                        .of(CHASSIS_MAX_VELOCITY.in(MetersPerSecond) / DRIVE_BASE_RADIUS.in(Meters));
        ...
        public static final MomentOfInertia ROBOT_MOI = KilogramSquareMeters.of(ROBOT_MASS.in(Kilograms)
                        * (BUMPER_WIDTH.in(Meters) * BUMPER_WIDTH.in(Meters)
                                        + BUMPER_LENGTH.in(Meters) * BUMPER_LENGTH.in(Meters))
                        / 12.0);
