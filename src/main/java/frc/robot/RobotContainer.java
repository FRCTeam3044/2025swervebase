...
public class RobotContainer {
        ...
        public RobotContainer() {
                final List<PhotonCameraProperties> camerasProperties =
                                ...
                                VisionConstants.photonVisionCameras; // load configs stored directly in
                ...
                switch (Robot.CURRENT_ROBOT_MODE) {
                        case REAL -> {
                                ...
                                powerDistribution = new PowerDistribution(0, PowerDistribution.ModuleType.kRev);
                        ...
                        case SIM -> {
                                ...
                                drive = new SwerveDrive(
                                                SwerveDrive.DriveType.GENERIC, gyroIOSim, frontLeft, frontRight,
                                                backLeft, backRight);
        ...
        private void configureAutoNamedCommands() {
                ...
                NamedCommands.registerCommand(
                                "my named command",
                                Commands.runOnce(() -> System.out.println("my named command executing!!!")));
        }

        private void configureAutoTriggers(PathPlannerAuto pathPlannerAuto) {

                pathPlannerAuto.event("hello world")
                                .onTrue(Commands.runOnce(() -> System.out.println("hello world!!!")));
        }
        ...
        private LoggedDashboardChooser<Auto> buildAutoChooser() {
                ...
                autoSendableChooser.addOption(
                                "Example Custom Auto With Choreo Trajectories: Rush",
                                new ExampleCustomAutoWithChoreoTrajectories());
                autoSendableChooser.addOption(
                                "Example Custom Auto With Choreo Trajectories",
                                new ExampleCustomAutoWithChoreoTrajectories2());
        ...
        /**
         * reconfigures button bindings if alliance station has changed re-create autos
         * if not yet created
         */
                ...
                if (FieldConstants.isSidePresentedAsRed() != isDSPresentedAsRed
                        ...
                        try {
                                ...
                                configureAutoTriggers(
                                                new PathPlannerAuto(autonomousCommand,
                                                                selectedAuto.getStartingPoseAtBlueAlliance()));
                        } catch (Exception e) {
         ...
         * {@link GenericHID} or one of its subclasses ({@link Joystick} or
         * {@link XboxController}), and then passing it to
        ...
        public void configureButtonBindings() {
                ...
                final JoystickDrive joystickDrive = new JoystickDrive(driveInput, () -> true,
                                driverXBox.getHID()::getPOV, drive);
                ...
                final JoystickDriveAndAimAtTarget exampleFaceTargetWhileDriving = new JoystickDriveAndAimAtTarget(
                                driveInput, drive, FieldConstants.SPEAKER_POSITION_SUPPLIER, exampleShooterOptimization,
                                0.75);
                ...
                final AutoAlignment exampleAutoAlignment = new AutoAlignment(
                                ...
                                () -> FieldConstants.toCurrentAlliancePose(
                                                new Pose2d(1.85, 7.3, Rotation2d.fromDegrees(90))),
                                () -> FieldConstants.toCurrentAlliancePose(
                                                new Pose2d(1.85, 7.74, Rotation2d.fromDegrees(90))),
        ...
        public void updateFieldSimAndDisplay() {
                ...
                Logger.recordOutput("FieldSimulation/OpponentRobotPositions",
                                AIRobotInSimulation.getOpponentRobotPoses());
                Logger.recordOutput(
