...
public class ModuleIOSpark implements ModuleIO {
    ...
    public ModuleIOSpark(int module) {
        ...
        new ConfigureableSparkClosedLoop(driveConfig, driveSpark.configAccessor, driveSpark, "Drive Module " + module);
        new ConfigureableSparkClosedLoop(turnConfig, turnSpark.configAccessor, turnSpark, "Turn Module " + module);
